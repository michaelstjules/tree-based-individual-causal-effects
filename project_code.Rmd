...
#would like to use usequants=FALSE for treatment variables, but true for everything else?
# FALSE by default; also try TRUE?
# since only 2x2 binary treatments, it's fine to use usequants=TRUE
#Is there a way to set a maximum iteration number (and either stop early and keep the result
# or restart?)
# numcut? 
```
